...
capture log close
log using resultados/est_xtsur_segmento_medio.log, replace
...
//
quietly xtsur (ppu4 m1 m1_20 ym) (ppu7 m1 m1_20 ym) if  ym >= ym(2011,1)
	// despu'es de ejecutar xtreg xtsur tiene problemas para "cargar".
	putexcel (C13) = matrix( e(b) )
 	putexcel (A13) = "`e(cmdline)'"
su ppu4 ppu7 if e(sample)==1
