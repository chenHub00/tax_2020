...
*gen l_ppu = log(ppu)
egen gr_marca_ciudad = group(marca2 cve_ciudad)
...
drop year month Periodo INP* tipo pp_lt_cerveza m_df_p m_otro_precio ///
 marca_str
...
drop gr_
drop marca2_str marca dppu

reshape wide d_ lag_ lagd_ l_* pp ppu pzas sd_*, i(ym cve_ciudad) j(marca2) 
