...
save "$datos/2020/tabla_adol_fin.dta", replace
...
save "$datos/2018/tabla_adol_fin.dta", replace
...
append using "$datos/2020/tabla_adol_fin.dta", generate(ap_2018_2020) 
drop ad1a01- ad1a05 
...
save "$datos/2020/adol_18_20.dta", replace
