...
set more off  
capture log close
log using "resultados/encuesta/para_precio_w2.log", replace
...
recode cantidad_cigarros . = 14 if marca == 1 & q029 <=46.5
recode cantidad_cigarros . = 20 if marca == 1 & q029 >46.5

recode cantidad_cigarros . = 14 if marca == 2 & q029 <=43.15
recode cantidad_cigarros . = 20 if marca == 2 & q029 >43.15

recode cantidad_cigarros . = 14 if marca == 3 & q029 <=42
//recode cantidad_cigarros . = 18 if marca == 3 & q029 <=42
// 18 queda en 20
recode cantidad_cigarros . = 20 if marca == 3 & q029 <=42.025
//recode cantidad_cigarros . = 24 if marca == 3 & q029 <=47.5
recode cantidad_cigarros . = 25 if marca == 3 & q029 >47.5

recode cantidad_cigarros . = 20 if marca == 4 & q029 <=55.875
recode cantidad_cigarros . = 25 if marca == 4 & q029 >55.875

recode cantidad_cigarros . = 14 if marca == 5 & q029 <=53
recode cantidad_cigarros . = 20 if marca == 5 & q029 >53

recode cantidad_cigarros . = 14 if marca == 6 & q029 <=31
//recode cantidad_cigarros . = 15 if marca == 6 & q029 <=38.5
//recode cantidad_cigarros . = 24 if marca == 6 & q029 >46.25
// 15 y 24 a 20:
recode cantidad_cigarros . = 20 if marca == 6 & q029 <=46.25

recode cantidad_cigarros . = 14 if marca == 7 & q029 <=39.75
recode cantidad_cigarros . = 20 if marca == 7 & q029 <=50
//recode cantidad_cigarros . = 24 if marca == 7 & q029 >50
...
save "$datos/cantidades_cigarros_w2.dta", replace
