...
set more off  
capture log close
log using "resultados/encuesta/para_precio_w7.log", replace
...
//recode cantidad_cigarros . = 15 if marca == 3 & q029 <=43.5
//recode cantidad_cigarros . = 18 if marca == 3 & q029 <=51.97
// 18 queda en 20
recode cantidad_cigarros . = 20 if marca == 3 & q029 <=47.84
// recode cantidad_cigarros . = 24 if marca == 3 & q029 <=49.5
recode cantidad_cigarros . = 25 if marca == 3 & q029 >49.5
...
//recode cantidad_cigarros . = 24 if marca == 6 & q029 <=54.75
// 15 y 24 a 20:
recode cantidad_cigarros . = 25 if marca == 6 & q029 >54.75

recode cantidad_cigarros . = 14 if marca == 7 & q029 <=47.5
recode cantidad_cigarros . = 20 if marca == 7 & q029 <=58.58
//recode cantidad_cigarros . = 24 if marca == 7 & q029 >58.58
...
save "$datos/cantidades_cigarros_w7.dta", replace
