...
set more off  
capture log close
log using "resultados/encuesta/para_precio_w1.log", replace
...
recode cantidad_cigarros . = 14 if marca == 1 & q029 <=45.5
recode cantidad_cigarros . = 20 if marca == 1 & q029 >45.5

recode cantidad_cigarros . = 14 if marca == 2 & q029 <=44.5
recode cantidad_cigarros . = 20 if marca == 2 & q029 >44.5

recode cantidad_cigarros . = 14 if marca == 3 & q029 <=39.5
//recode cantidad_cigarros . = 18 if marca == 3 & q029 <=41.5
// 18 queda en 20
recode cantidad_cigarros . = 20 if marca == 3 & q029 <=41.4
// recode cantidad_cigarros . = 24 if marca == 3 & q029 <=45.5
recode cantidad_cigarros . = 25 if marca == 3 & q029 >45.5

recode cantidad_cigarros . = 20 if marca == 4 & q029 <=53.74
recode cantidad_cigarros . = 25 if marca == 4 & q029 >53.74

recode cantidad_cigarros . = 14 if marca == 5 & q029 <=51.555
//recode cantidad_cigarros . = 18 if marca == 5 & q029 <=51
recode cantidad_cigarros . = 20 if marca == 5 & q029 >51

recode cantidad_cigarros . = 14 if marca == 6 & q029 <=29.5
//recode cantidad_cigarros . = 15 if marca == 6 & q029 <=37
//recode cantidad_cigarros . = 24 if marca == 6 & q029 >45
// 15 y 24 a 20:
recode cantidad_cigarros . = 20 if marca == 6 & q029 <=45

//recode cantidad_cigarros . = 15 if marca == 7 & q029 <=33.5
recode cantidad_cigarros . = 20 if marca == 7 & q029 <=47.25
//recode cantidad_cigarros . = 24 if marca == 7 & q029 >47.25
...
save "$datos/cantidades_cigarros_w1.dta", replace
